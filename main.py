...
from utils_dsbn.save_and_other_functions import save_model, visdom_visualization, save_his, save_predict_labels, \
    train_history
...
for task in tasks:
    ...
    # sour_tar_dataset_names = [['CWRU_0hp_4', 'SBDS_0K_4_06'], ['CWRU_0hp_4', 'SBDS_1K_4_06'],
    #                           ['CWRU_0hp_4', 'SBDS_2K_4_06'], ['CWRU_0hp_4', 'SBDS_3K_4_06'],
    #                           ['CWRU_1hp_4', 'SBDS_1K_4_06'], ['CWRU_2hp_4', 'SBDS_2K_4_06'],
    #                           ['CWRU_3hp_4', 'SBDS_3K_4_06']]
    sour_tar_dataset_names = [['CWRU_1hp_4', 'SBDS_1K_4_06']]

    path = 'C:/Users/lenovo/Desktop/result/'
    ...
    for load_transfer in sour_tar_dataset_names:
        ...
        for number in range(0, 10):
            ...
            parser.add_argument('--n_epochs_1', type=int, default=30)  # 5
            parser.add_argument('--n_epochs_2', type=int, default=50)  # 30
            parser.add_argument('--n_epochs_3', type=int, default=100)  # 100
            parser.add_argument('--warm_steps', type=int, default=40)  # 40
            parser.add_argument('--n_target_samples', type=int, default=1)  # The number of target images of per class
            parser.add_argument('--batch_size', type=int, default=64)  # 64
            parser.add_argument('--domain_loss_hyp', type=int, default=0.1)  # 0.1
            parser.add_argument('--positive_dcd_hyp', type=int, default=1)  # 1
            parser.add_argument('--negative_dcd_hyp', type=int, default=0.2)  # 0.2
            parser.add_argument('--sour_tar_per_cls_hyp', type=int, default=1)  # 1
            parser.add_argument('--tar_tar_mmd_hyp', type=int, default=1)  # 1
